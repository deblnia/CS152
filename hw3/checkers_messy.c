...
{
	if(valid_move(char player, unsigned int startrow, 
		unsigned int startcol, unsigned int endrow, 
		unsigned int endcol, char board[8][8]) == 1)
	{ 	//One Case 
		...
		//move one space or two spaces 
		//another move if capture opp piece 	  
} 
